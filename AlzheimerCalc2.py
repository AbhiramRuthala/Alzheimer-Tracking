...
# Call NeuronRate to input a certain neuron degeneration rate
        NeuronRate = int(input("At what rate are the neurons declining? "))
        result = AlzheimerDiseaseCalc - NeuronRate
